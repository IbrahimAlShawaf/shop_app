...
import 'package:plant_app/screens/buyscreen.dart';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () => Navigator.pop(
              context), // pop màn này trên stack để quay về màn trước
        ),
        title: Text('Buy Now'),
      ),
                    ...
                    children: [
                      ...
                      Hero(
                          ...
                          child: Padding(
                              ...
                              child: Text(product.size.toString() + ' cm'))),
                      Hero(
                        tag: 'color',
                        child: ColorDot(
                          color: product.color,
